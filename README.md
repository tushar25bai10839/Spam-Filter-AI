...
A lightweight, transparent, and fully functional spam filter built entirely in Python without using external machine learning libraries (such as scikit-learn). This project demonstrates the fundamental mathematics behind Natural Language Processing (NLP) and Bayes' Theorem.
Overview
...
Educational Code: Clearly written to explain the mathematical logic
...
Type a message (for example: "Win a free cash prize") to see the result
...
To prevent the "Zero Frequency Problem" (where a new word crashes the probability to 0), Laplace Smoothing is used:
...
Learned 154 unique words. System ready. Type a message to check.
